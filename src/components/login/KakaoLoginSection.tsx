  ...
  return (
    <div className={styles.login_section}>
      ...
      <div className={styles.login_box}>
        <Button elements={buttonElements} style={STYLE} icon={<KakaoIcon />} />
        <div className={styles.text_wrapper}>
          <p className={styles.text} onClick={() => navigate("/email-login")}>
            이메일로 로그인
          </p>
          |
          <p className={styles.text} onClick={() => navigate("/signup")}>
            이메일로 회원가입
          </p>
        </div>
      </div>
